...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <body>
        ...
        <div id="wrapper">
            <header>
                <section id="top-area">
                    <p>Phone orders: 0000-0000-0000| Email us: <a href="mailto:office@shop.com">veskovujovic@yahoo.com</a></p>
            ...
            <footer>
                ...
                <section class="clearfix">
                    <div id="copyright">
                        ...
                        <p id="store-copy">&copy; 2015 eCommerce. By Vesko Vujovic.</p>
                    </div><!-- end copyright -->
                    <div id="connect">
                    ...
                    <div id="payments">
                        ...
                        {{HTML::image('img/payment-methods.gif', 'Payment Methods')}}
                    </div><!-- end payments -->
                </section>
            </footer>
        </div><!-- end wrapper -->
